...
<body>
	...
	<h2 style="margin-top:-15px">תקלה</h2>
	</div>
	...
	<table width="100%" border="1">
		...
		<?php 
			...
			echo "</table>";
			echo "<br>";
			echo "<textarea id='issueText' name='issueText' style='width:600px; height:300px; margin-right:50px;' disabled>". $row{'issueText'} ."</textarea>";
